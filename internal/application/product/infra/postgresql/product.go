...
func (m *MockProductRepository) GetProducts(ctx context.Context, offset, limit int) ([]entity.Product, error) {
	m.ctrl.T.Helper()
...
// GetProducts mocks base method.
func (m *MockProductService) GetProducts(ctx context.Context, offset, limit int) ([]entity.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProducts", ctx, offset, limit)
	ret0, _ := ret[0].([]entity.Product)
	ret1, _ := ret[1].(error)
